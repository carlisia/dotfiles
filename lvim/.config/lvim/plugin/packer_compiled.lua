...
_G.packer_plugins = {
  ...
  ["jaq-nvim"] = {
    config = { "\27LJ\2\nÖ\1\0\0\5\0\n\0\r6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\b\0005\3\4\0005\4\3\0=\4\5\0035\4\6\0=\4\a\3=\3\t\2B\0\2\1K\0\1\0\tcmds\1\0\0\rexternal\1\0\4\rmarkdown\vglow %\vpython\14python3 %\ash\26/usr/local/bin/bash %\ago\rgo run %\rinternal\1\0\0\1\0\2\bvim\rsource %\blua\14luafile %\nsetup\rjaq-nvim\frequire\0" },
    loaded = true,
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'lsp-colors.nvim', 'Comment.nvim', 'lightspeed.nvim', 'vim-highlighturl', 'vim-signature', 'nvim-bqf', 'octo.nvim', 'gitsigns.nvim', 'numb.nvim', 'git-blame.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
