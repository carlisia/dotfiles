...
_G.packer_plugins = {
  ...
  ["jaq-nvim"] = {
    config = { "\27LJ\2\nÖ\1\0\0\5\0\n\0\r6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\b\0005\3\4\0005\4\3\0=\4\5\0035\4\6\0=\4\a\3=\3\t\2B\0\2\1K\0\1\0\tcmds\1\0\0\rexternal\1\0\4\rmarkdown\vglow %\ash\26/usr/local/bin/bash %\ago\rgo run %\vpython\14python3 %\rinternal\1\0\0\1\0\2\blua\14luafile %\bvim\rsource %\nsetup\rjaq-nvim\frequire\0" },
    loaded = true,
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitlinker.nvim', 'git-blame.nvim', 'vim-highlighturl', 'gitsigns.nvim', 'octo.nvim', 'numb.nvim', 'lsp-colors.nvim', 'vim-signature', 'nvim-bqf', 'lightspeed.nvim', 'Comment.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
