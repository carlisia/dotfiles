...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'numb.nvim', 'nvim-bqf', 'Comment.nvim', 'lsp-colors.nvim', 'vim-highlighturl', 'octo.nvim', 'vim-signature', 'lightspeed.nvim', 'git-blame.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
