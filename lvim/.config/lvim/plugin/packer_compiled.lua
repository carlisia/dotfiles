...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bqf', 'Comment.nvim', 'vim-highlighturl', 'git-blame.nvim', 'gitsigns.nvim', 'octo.nvim', 'vim-signature', 'lsp-colors.nvim', 'lightspeed.nvim', 'numb.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
