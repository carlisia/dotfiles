...
_G.packer_plugins = {
  ...
  ["jaq-nvim"] = {
    config = { "\27LJ\2\nÖ\1\0\0\5\0\n\0\r6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\b\0005\3\4\0005\4\3\0=\4\5\0035\4\6\0=\4\a\3=\3\t\2B\0\2\1K\0\1\0\tcmds\1\0\0\rexternal\1\0\4\ash\26/usr/local/bin/bash %\vpython\14python3 %\ago\rgo run %\rmarkdown\vglow %\rinternal\1\0\0\1\0\2\blua\14luafile %\bvim\rsource %\nsetup\rjaq-nvim\frequire\0" },
    loaded = true,
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'gitsigns.nvim', 'diffview.nvim', 'Comment.nvim', 'octo.nvim', 'nvim-bqf', 'vim-highlighturl', 'numb.nvim', 'git-blame.nvim', 'gitlinker.nvim', 'lsp-colors.nvim', 'vim-signature', 'lightspeed.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
