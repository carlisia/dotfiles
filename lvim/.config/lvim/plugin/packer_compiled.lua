...
_G.packer_plugins = {
  ...
  snap = {
    ...
    loaded = true,
    path = "/Users/carlisiac/.local/share/lunarvim/site/pack/packer/start/snap",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'diffview.nvim', 'git-blame.nvim', 'Comment.nvim', 'octo.nvim', 'indent-blankline.nvim', 'gitsigns.nvim', 'gitlinker.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
