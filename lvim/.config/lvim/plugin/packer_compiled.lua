...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-highlighturl', 'nvim-bqf', 'numb.nvim', 'gitsigns.nvim', 'lsp-colors.nvim', 'lightspeed.nvim', 'Comment.nvim', 'octo.nvim', 'git-blame.nvim', 'vim-signature'}, { event = "BufRead *" }, _G.packer_plugins)]]
